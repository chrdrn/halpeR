...
#' @param osf_component_id  A character vector specifying the corresponding node ID(s) for each component.
#'
...
#' \dontrun{
#' local_folder <- c("base")
#' osf_component <- c("jmipd")
#' download_osf_data(local_folder, osf_component)
#' }
